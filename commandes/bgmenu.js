...
zokou({ nomCom: "bugmenu", categorie: "Menu" }, async (dest, zk, commandeOptions) => {
    ...
    var emoji = { "Général": "", "Logo": "", "": "", "weeb": "", "Recherche": "", "conversion": "", "groupe": "","Téléchargement":"" };
...
*𝚙𝚘𝚠𝚎𝚛𝚎𝚍 𝚋𝚢 𝚖𝚊𝚕𝚟𝚒𝚗 𝚔𝚒𝚗𝚐*\n\n`;
    ...
    try {
        zk.sendMessage(dest, { image: { url: link }, caption: menuMsg, footer: "©Malvin King" }, { quoted: ms });
    }
    catch (e) {
